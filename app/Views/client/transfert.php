...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-header bg-white border-0 pt-3">
        <h5 class="mb-0">Transfert automatique</h5>
    </div>
    <div class="card-body">
        <form action="<?= site_url('/client/transfert') ?>" method="post" class="row g-3">
            <?= csrf_field() ?>
            <div class="col-md-6">
                <label for="numero_receiver" class="form-label">Numéro du destinataire</label>
                <input type="text" name="numero_receiver" id="numero_receiver" class="form-control" required>
            </div>
            <div class="col-md-6">
